      ...
      return ListView(
        ...
        children: [
          ...
          const SfEmptyState(
            ...
            subtitle:
                'Tracks DV and Approved Budget folders at ENG, BUD, ACC, TRE, and MAY. '
                'Payroll uses payslip access — not physical QR at HR.',
          ),
        ],
      );
    }
    ...
    return ListView(
      ...
      children: [
        if (isHead) ...[
          ...
          const SfClerkPageOverviewCard(screen: SfClerkScreen.register),
          const SizedBox(height: 10),
    ...
    return SfFormCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          _step('1', 'Print the QR label and attach it to the folder'),
          const SizedBox(height: 8),
          _step(
            '2',
            isHead
                ? 'Tell staff to Mark OUT on Scanner when forwarding'
                : 'Mark OUT on Scanner when you forward to another office',
          ),
          const SizedBox(height: 8),
          _step('3', 'Receiving office scans IN when the folder arrives'),
        ],
      ),
    );
  }
