...
/// Per-device “remind later” for alerts (local only).
///
/// Hides an alert until the snooze time — no acknowledge/restore flow.
/// Production can move this to a shared server table later.
...
class AlertActionState {
  ...
  bool get isHidden => snoozeUntil != null; // “Later” only — no permanent acknowledge
