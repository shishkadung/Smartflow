...
/// PDF module header — kicker · SMARTFLOW · office badge (account menu).
        ...
        children: [
          ...
          if (showProfileBadge) ...[
            ...
            SfOfficeCodeBadge(
              ...
              onTap: onProfileTap ?? () => showSfAccountMenu(context),
            ),
          ],
        ],
      ),
...
/// Signup top row — CREATE ACCOUNT · SMARTFLOW.
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        ...
        side: const BorderSide(color: Color(0x330B1F3A)),
...
/// Institutional scanner chrome (hero Scan screen).
...
/// Square gradient avatar (profile card) — optional network photo.
